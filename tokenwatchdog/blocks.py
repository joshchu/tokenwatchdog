...
The rule (as established by ccusage's block algorithm): a new block starts
at the first activity that is either `duration` or more past the current
block's start, or `duration` or more after the previous activity. Shared by
